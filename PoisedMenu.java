...
// This is a new class 'PoisedMenu'.
// It will run the main program and call on info and methods in the other classes 'NewProject' and 'NewPerson'.
// As per the compulsory task 2 requirements, it will firstly allow the user to enter input for a new project.
// The details for the project are then built into an object and displayed for the user.
// They are then shown a short menu which allows them to edit the project, contractor details, or finalize the project.
